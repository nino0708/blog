...
const ja: Dict = {
  ...
  'near.openGoogleMaps': 'Googleマップで開く',
  ...
  'home.quiz.title': '今日の建物クイズ、挑戦してみませんか？',
  'home.quiz.desc': '毎日X（旧Twitter）で出題中。答えはこのサイトの記事で確認できます。',
  'home.quiz.cta': '今日のクイズに挑戦する →',
...
const en: Dict = {
  ...
  'near.openGoogleMaps': 'Open in Google Maps',
  ...
  'home.quiz.title': "Try today's building quiz?",
  'home.quiz.desc': 'Posted daily on X (Twitter). Confirm the answer in the article on this site.',
  'home.quiz.cta': "Take today's quiz →",
