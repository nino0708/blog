...
const ja: Dict = {
  ...
  'nav.read': '記事を読む',
  'nav.tools': '調べる',
  'nav.desc.buildings': 'オフィスビルとタワーマンション',
  'nav.desc.bridges': '震災復興橋梁から長大橋まで',
  'nav.desc.expressways': '首都高のジャンクションやトンネル',
  'nav.desc.railways': '駅・路線・空港',
  'nav.desc.tourism': '展望台や街歩きのスポット',
  'nav.desc.near': '好きな場所の近くの建物を地図で',
  'nav.desc.database': '全建物を高さ・竣工年・エリアで引く',
  'nav.desc.rankings': '関東で高い・大きいビル',
  'nav.desc.stamps': '行った建物を記録して踏破率を上げる',
  'home.title2': '日本の高層建築を、\n一棟ずつ記録する。',
  'home.desc2': 'ビル・タワーマンション・橋・高速道路まで。竣工年や高さ、再開発の背景を公開情報をもとにまとめています。',
  'home.popular': 'よく見られている',
  'home.tools.title': '目的から探す',
  'home.tools.desc': '地図で近くの建物を探したり、図鑑で高さや竣工年から引いたりできます。',
  'home.cats.title': 'カテゴリから読む',
  'home.cats.count': '%n本',
  'home.tall.title': '高さトップ5',
  'home.tall.desc': '記事のある建物の中で高い順。',
  'home.tall.more': '図鑑で全部見る →',
  'home.areas.title': 'エリアから探す',
  'home.areas.desc': '収録数の多い市区。図鑑をそのエリアで絞り込んで開きます。',
  'home.feed.more': 'ビル・マンションの記事をすべて見る →',
  'nav.search': '検索',
  'search.label': 'サイト内を検索',
  'search.placeholder': '建物名・エリア・設計者で検索',
  'search.more': 'すべての検索結果を見る →',
  'search.empty': '見つかりませんでした。別の言葉（エリア名・読み方・英語名など）で試してください。',
  'search.stub': '準備中',
  'search.count': '%n件',
  'search.all': 'すべて',
  'search.title': 'サイト内検索',
  'search.lead': '建物・橋・高速道路・交通網の記事と、図鑑に載っている建物をまとめて探せます。名前のほか、エリア・開発会社・設計者・英語名でも引けます。',
  'nav.latest': '新着',
  'nav.home': 'ビル・マンション',
  'nav.database': '図鑑',
  'nav.about': 'このブログについて',
...
const en: Dict = {
  ...
  'nav.read': 'Read',
  'nav.tools': 'Explore',
  'nav.desc.buildings': 'Office towers and residential towers',
  'nav.desc.bridges': 'From historic river bridges to record spans',
  'nav.desc.expressways': 'Shuto Expressway junctions and tunnels',
  'nav.desc.railways': 'Stations, lines and airports',
  'nav.desc.tourism': 'Observation decks and walks',
  'nav.desc.near': 'Buildings near any place, on a map',
  'nav.desc.database': 'Every building by height, year and area',
  'nav.desc.rankings': 'The tallest and largest in Kanto',
  'nav.desc.stamps': 'Log the buildings you have visited',
  'home.title2': 'Japan’s high-rise architecture,\nrecorded one building at a time.',
  'home.desc2': 'Towers, residences, bridges and expressways — completion years, heights and the story behind each redevelopment, drawn from public sources.',
  'home.popular': 'Popular',
  'home.tools.title': 'Find what you need',
  'home.tools.desc': 'Find buildings near you on the map, or look them up by height and year in the database.',
  'home.cats.title': 'Browse by category',
  'home.cats.count': '%n articles',
  'home.tall.title': 'Top 5 by height',
  'home.tall.desc': 'The tallest buildings with an article.',
  'home.tall.more': 'See all in the database →',
  'home.areas.title': 'Browse by area',
  'home.areas.desc': 'Cities and wards with the most buildings. Opens the database filtered to that area.',
  'home.feed.more': 'See all building articles →',
  'nav.search': 'Search',
  'search.label': 'Search the site',
  'search.placeholder': 'Search buildings, areas, architects',
  'search.more': 'See all results →',
  'search.empty': 'No matches. Try another word — an area, a Japanese name, or an architect.',
  'search.stub': 'Coming soon',
  'search.count': '%n results',
  'search.all': 'All',
  'search.title': 'Search',
  'search.lead': 'Search every article — buildings, bridges, expressways and transport — plus the buildings listed in the database. Look things up by name, area, developer, architect or Japanese name.',
  'nav.latest': 'Latest',
  'nav.home': 'Buildings',
  ...
  'db.filter.all': 'All',
  'area.filter.label': 'Filter by area',
  'area.filter.all': 'All',
  'area.result': 'Showing %n articles',
  'db.sort.label': 'Sort',
