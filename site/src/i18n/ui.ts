...
const ja: Dict = {
  ...
  'near.title': '周辺の建物をさがす',
  'near.lead': '自宅や駅、好きな場所を入れると、その周りにある建物を近い順に並べて地図に出します。ここを起点に建物巡りの一日を組み立てられます。',
  'near.placeholder': '住所・駅名・建物名（例: 東京都港区六本木6-10-1）',
  'near.search': 'さがす',
  'near.useGeo': '現在地から',
  'near.radius': '範囲',
  ...
  'near.notFound': '場所が見つかりませんでした。住所や駅名を変えて試してください。',
  'near.geoDenied': '現在地を取得できませんでした。ブラウザの位置情報の許可を確認してください。',
  'near.geoUnsupported': 'このブラウザは現在地の取得に対応していません。',
  'near.hintTitle': '使い方',
  'near.hint': '入力欄は日本語の住所・駅名・建物名に対応しています（国土地理院の住所検索を利用）。現在地ボタンを押すと、いまいる場所の周りを表示します。',
...
const en: Dict = {
  ...
  'near.title': 'Find buildings near a place',
  'near.lead': 'Enter your home, a station, or anywhere you like, and we list the buildings around it by distance and put them on a map — a starting point for a day of building-spotting.',
  'near.placeholder': 'Address, station or building name (Japanese input works best)',
  'near.search': 'Search',
  ...
  'near.notFound': 'Could not find that place. Try a different address or station name.',
  ...
  'near.hint': 'The search box takes Japanese addresses, station names and building names (powered by the Geospatial Information Authority of Japan). The location button shows what is around you right now.',
